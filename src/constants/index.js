    ...
    children: [
      {
        ...
        data: {
          ...
          portrait: true,
          description: [
            "I'm a CS Honors + Math double major at UT Austin (Dean's Scholars), minoring in Robotics. I like building things that have to work in the physical world, where a lot of the hard problems turn out not to be in the code.",
            "Right now I'm an undergraduate researcher at the Autonomous Mobile Robotics Lab, tracking people in 3D across six synchronized cameras with ROS2 and NVIDIA DeepStream.",
      ...
      },
      {
        ...
        data: {
          ...
          description: [
            ...
            "I watch a lot of anime and I'm always open to recommendations. My all-time favorites are Attack on Titan and Jujutsu Kaisen.",
            "I really like cooking. There are a few recipes I've been refining for years, but most nights I still get my ideas from YouTube and Instagram.",
    ...
    children: [
      {
        ...
        data: {
          ...
          description: [
            ...
            "</html>",
            "It worked. It was also the last time I kept a website simple.",
          ],
        },
      },
      {
